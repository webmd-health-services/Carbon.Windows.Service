...
function Grant-CServicePermission
{
    ...
    * FullControl
    ...
    .EXAMPLE
    Grant-CServicePermission -Identity FALCON\Chewbacca -Name Hyperdrive -Permission 'QueryStatus, EnumerateDependents, Start, Stop'
    ...
    Write-Information "Granting ""$($account.FullName)"" ""${Permission}"" permission to the ""${Name}"" service."
