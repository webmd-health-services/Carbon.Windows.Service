...
function Get-CServicePermission
{
    ...
    returns them. Any system audit or alarm ACEs are skipped. Returned objects will have a `ServiceAccessRights`
    property that is a flags enumeration of the permissions.
