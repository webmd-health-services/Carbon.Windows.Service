...
@{
    ...
    RootModule = 'Carbon.Windows.Service.psm1'

    # Version number of this module.
    ModuleVersion = '1.0.0'

    # ID used to uniquely identify this module
    GUID = 'b341d491-b0ca-4581-9daa-6cbc7d8643af'
    ...
    Description = 'Functions to get and manage Windows service configuration and security.'
    ...
    PrivateData = @{
        ...
        PSData = @{
            ...
            ProjectUri = 'https://github.com/webmd-health-services/Carbon.Windows.Service'
            ...
            ReleaseNotes = 'https://github.com/webmd-health-services/Carbon.Windows.Service/blob/main/CHANGELOG.md'
