...
Describe 'Install-CService' {
    ...
    Context 'service does not exist' {
        It 'sets all properties' {
            ...
            WhenInstalling -WithArgs @{
                ...
                FailureRestartDelay = '0:00:01.234'
                OnSecondFailure = 'RunCommand'
                FailureCommand = 'echo "Failed!"'
                FailureRunCommandDelay = '0:00:05.678'
                OnThirdFailure = 'Reboot'
                FailureRebootDelay = '0:00:09.012'
            } -IsIdempotent
            ThenError -IsEmpty
            ThenOutput -IsEmpty
    ...
    Context 'service exists' {
        ...
        $propertyTestCases = @(
            ...
            @{
                PropertyName = 'FailureRestartDelay'
                InstallWith = @{ FailureRestartDelay = '0:07:08.901' }
                ThenService = @{ HasRestartDelay = '0:00:00' }
            },
            @{
                PropertyName = 'FailureRebootDelay'
                InstallWith = @{ FailureRebootDelay = '0:00:02.345' }
            ...
            @{
                PropertyName = 'FailureRunCommandDelay'
                InstallWith = @{ FailureRunCommandDelay = '6.07:08:09.012' }
    ...
    Context 'failure actions' {
        ...
        It 're-installs idempotently when <FailureAction> failure action delay changes' -ForEach $delayTestCases {
            ...
            $installArgName = "Failure${FailureAction}Delay"
    ...
    It 'resets missing properties of missing arguments back to defaults' {
            WhenInstalling -WithArgs @{
                ...
                FailureRunCommandDelay = '0:00:05.678'
                OnThirdFailure = 'Reboot'
                FailureRebootDelay = '0.00:00:09.012'
            }
            ThenError -IsEmpty
            ThenOutput -IsEmpty
