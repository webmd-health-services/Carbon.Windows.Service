...
* Rename every file that has `Carbon.Windows.Service` in its name, replacing `Carbon.Windows.Service` with the module name.
* Replaces `Carbon.Windows.Service` in every file with the module name.
